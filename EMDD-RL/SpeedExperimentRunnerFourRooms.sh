    ...
    then
      ...
      do
        ...
        do
          ...
          do
              echo EMDD-DDExperimentalFourRooms.py data=$dataset algh=$algorithm search=$SEARCH method=$METHOD skip=$SKIPPING
              python EMDD-DDExperimentalFourRooms.py data=$dataset algh=$algorithm search=$SEARCH method=$METHOD skip=$SKIPPING
          done
        done

      done
    else
      echo EMDD-DDExperimentalFourRooms.py data=$dataset algh=$algorithm search=0 method=0 skip=0
      python EMDD-DDExperimentalFourRooms.py data=$dataset algh=$algorithm search=0 method=0 skip=0
    fi
