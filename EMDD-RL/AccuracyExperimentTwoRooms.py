...
# Experiment folder
if algorithm == "EMDD":
    experiment_folder = "AccuracyExperiments/"+data_version+"/"+dataset_defs[DATASET]+"/"+algorithm+"/"+METHOD+"/"+SEARCH_SET+"/"+str(SKIPPING_FACTOR)
else:
    experiment_folder = "AccuracyExperiments/"+data_version+"/"+dataset_defs[DATASET]+"/"+algorithm

experiment_folder += "/#"+str(POSITIVE_BAG_COUNT)+"Positive"+"#"+str(NEGATIVE_BAG_COUNT)+"Negative"

if not os.path.exists(experiment_folder):
    create_path = "AccuracyExperiments"
