...
latex_file = open("EMDDFourRoomsSpeedAverageResultsDD.txt", "w")
...
for DATASET in dataset_array:
           ...
           # Experiment folder
                ...
                json[dataset_defs[DATASET]]["precision2"] = precision2
...
with open('SpeedExperimentVisualizationFourRooms/UpdatedSpeedExperimentDD.json', 'w') as fp:
    js.dump(json, fp)
...
f1_cell.append("")
import pandas as pd
EXCEL_FILE_NAME = "SPEEDExperimentDDResult.xlsx"
try:
...
EXCEL_FILE_NAME2 = "FourRoomsSPEEDExperimentDDResultAveraged.xlsx"
try:
