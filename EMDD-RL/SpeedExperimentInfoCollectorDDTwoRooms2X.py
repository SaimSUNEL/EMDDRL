...
latex_file = open("DDTwoRooms2XSpeedAverageResults.txt", "w")
...
import pandas as pd
EXCEL_FILE_NAME = "SPEEDExperimentDDTwoRooms2XResult.xlsx"
try:
...
EXCEL_FILE_NAME2 = "SPEEDExperimentDDTwoRooms2XResult.xlsx"
try:
