...
for file in files:
    ...
    if positive_episode_count < 20 or negative_episode_count < 20:
        print(colored("File %s is problematic [P:%d-N:%d]" % (file, positive_episode_count, negative_episode_count), "red"))
        os.remove(file)
