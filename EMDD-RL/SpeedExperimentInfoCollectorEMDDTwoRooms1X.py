...
latex_file = open("EMDDTwoRooms1XSpeedAverageResults.txt", "w")
...
EXCEL_FILE_NAME = "SPEEDExperimentEMDDTwoRooms1XResult.xlsx"
try:
...
EXCEL_FILE_NAME2 = "SPEEDExperimentEMDDTwoRooms1XResultAveraged.xlsx"
try:
