...
latex_file = open("DDTwoRooms3XSpeedAverageResults.txt", "w")
...
import pandas as pd
EXCEL_FILE_NAME = "SPEEDExperimentDDTwoRooms3XResult.xlsx"
try:
...
EXCEL_FILE_NAME2 = "SPEEDExperimentDDTwoRooms3XResultAveraged.xlsx"
try:
