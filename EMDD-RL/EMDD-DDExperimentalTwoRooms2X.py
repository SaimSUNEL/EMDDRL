...
emdd_results = []
dd_results = []
eliminated_states = [282,283,284,285,286,
                     323,324,325,326,327,
                     364,365,366,367,368,
                     405,406,407,408]
average_count = 0
...
if algorithm == "EMDD":
    ...
    experiment_folder = "SpeedExperimentsTwoRooms2X/"+data_version+"/"+dataset_defs[DATASET]+"/"+algorithm

experiment_folder += "/#"+experiment_date+"#"+experiment_time

if not os.path.exists(experiment_folder):
    create_path = "SpeedExperimentsTwoRooms2X"
...
for experiment_id in range(1, 101):
    ...
    data_directory = "MIL/data/TwoRooms2XQAgentTrajectories/"
    experiment_number = experiment_id

    file_name = "TwoRooms2XBagExperiment["+str(experiment_number)+"].txt"
...
two_rooms_env_v2 = RLTwoRoomsEnvironment.RLTwoRoomsEnvironment('v7', is_step_restricted=True, step_limit=500)
