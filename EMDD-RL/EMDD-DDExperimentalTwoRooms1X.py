...
# Experiment folder
if algorithm == "EMDD":
    experiment_folder = "SpeedExperimentsTwoRooms1X/"+data_version+"/"+dataset_defs[DATASET]+"/"+algorithm+"/"+METHOD+"/"+SEARCH_SET+"/"+str(SKIPPING_FACTOR)
else:
...
if not os.path.exists(experiment_folder):
    create_path = "SpeedExperimentsTwoRooms1X"
...
two_rooms_env_v2 = RLTwoRoomsEnvironment.RLTwoRoomsEnvironment('v6', is_step_restricted=True, step_limit=500)
