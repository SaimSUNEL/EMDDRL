                    ...
                    for SKIPPING_FACTOR in SKIP_ARRAY:
                        ...
                        for POSITIVE_BAG_COUNT in POSITIVE_BAG_COUNT_ARRAY:
                            ...
                            for NEGATIVE_BAG_COUNT in NEGATIVE_BAG_COUNT_ARRAY:
                                ...
                                # Experiment folder
                                if algorithm == "EMDD":
                                    experiment_folder = "AccuracyExperiments/" + data_version + "/" + dataset_defs[
...
with open('AccuracyExperimentVisualization/AccuracyExperiment.json', 'w') as fp:
    js.dump(json, fp)
import pandas as pd
EXCEL_FILE_NAME = "AccuracyExperimentEMDDResult.xlsx"
try:
...
result_file.save()
import pandas as pd
EXCEL_FILE_NAME = "AccuracyExperimentDDResult.xlsx"
try:
