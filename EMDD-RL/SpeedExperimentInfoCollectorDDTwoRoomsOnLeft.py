...
latex_file = open("DDTwoRoomsOnLeftSpeedAverageResults.txt", "w")
...
import pandas as pd
EXCEL_FILE_NAME = "SPEEDExperimentDDTwoRoomsOnLeftResult.xlsx"
try:
...
EXCEL_FILE_NAME2 = "SPEEDExperimentDDTwoRoomsOnLeftResult.xlsx"
try:
