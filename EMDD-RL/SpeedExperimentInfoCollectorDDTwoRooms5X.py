...
latex_file = open("DDTwoRooms5XSpeedAverageResults.txt", "w")
...
import pandas as pd
EXCEL_FILE_NAME = "SPEEDExperimentDDTwoRooms5XResult.xlsx"
try:
...
EXCEL_FILE_NAME2 = "SPEEDExperimentDDTwoRooms5XResultAveraged.xlsx"
try:
