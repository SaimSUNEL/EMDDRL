...
emdd_results = []
dd_results = []
eliminated_states = eliminated_states = [183,184, 185,
                     204,205,206,
                     246, 247, 248,
                     267,268,269]
...
four_rooms.saveEnvironmentImage("LogDDMapImagesFourRooms/"+data_version+""+dataset_defs[DATASET]+""+algorithm+".png")
