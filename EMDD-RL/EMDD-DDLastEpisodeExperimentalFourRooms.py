...
# Experiment folder
if algorithm == "EMDD":
    experiment_folder = "SpeedExperimentsFourRoomsLastEpisode/"+data_version+"/"+dataset_defs[DATASET]+"/"+algorithm+"/"+METHOD+"/"+SEARCH_SET+"/"+str(SKIPPING_FACTOR)
else:
    experiment_folder = "SpeedExperimentsFourRoomsLastEpisode/"+data_version+"/"+dataset_defs[DATASET]+"/"+algorithm

experiment_folder += "/#"+experiment_date+"#"+experiment_time

if not os.path.exists(experiment_folder):
    create_path = "SpeedExperimentsFourRoomsLastEpisode"
...
if algorithm == "EMDD":
    four_rooms.setEnvironmentImageTitle(data_version+""+dataset_defs[DATASET]+""+algorithm+SEARCH_SET+METHOD)
else:
    four_rooms.setEnvironmentImageTitle(data_version+""+dataset_defs[DATASET]+""+algorithm)


four_rooms.renderEnvironment()
if algorithm == "EMDD":
    four_rooms.saveEnvironmentImage(experiment_folder+data_version+""+dataset_defs[DATASET]+""+algorithm+SEARCH_SET+METHOD)
else:
    four_rooms.saveEnvironmentImage(experiment_folder+data_version+""+dataset_defs[DATASET]+""+algorithm)
