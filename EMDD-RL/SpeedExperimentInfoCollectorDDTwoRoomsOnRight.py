...
latex_file = open("DDTwoRoomsOnRightSpeedAverageResults.txt", "w")
...
import pandas as pd
EXCEL_FILE_NAME = "SPEEDExperimentDDTwoRoomsOnRightResult.xlsx"
try:
...
EXCEL_FILE_NAME2 = "SPEEDExperimentDDTwoRoomsOnRightResult.xlsx"
try:
