...
class KeyRoomEnvironmentV0(gym.Env):
    ...
    Note: a default reward range set to [-inf,+inf] already exists. Set it if you want a narrower range.
        ...
        self.row_tile_count = 11  # number of tiles in a row...
        self.column_tile_count = 10  # number of tiles in a column

        self.screen_width = 950//2+25
        ...
        self.unused_states.append(0 * self.row_tile_count + 6)
        self.states[0][6] = 2


        self.unused_states.append(0 * self.row_tile_count + 8)
        self.states[0][8] = 2

        self.unused_states.append(1 * self.row_tile_count + 8)
        self.states[1][8] = 2

        self.unused_states.append(2 * self.row_tile_count + 8)
        self.states[2][8] = 2
        #
        self.unused_states.append(2 * self.row_tile_count + 7)
        self.states[2][7] = 2
        #
        self.unused_states.append(2 * self.row_tile_count + 6)
        self.states[2][6] = 2
        ...
        self.states[1][5] = 0
        self.unused_states.remove(1*self.row_tile_count+5)
        #self.states[2][5] = 0
        #self.unused_states.remove(2 * self.row_tile_count + 5)
        self.states[3][5] = 0
        self.unused_states.remove(3 * self.row_tile_count + 5)


        self.states[5][1] = 0
        self.unused_states.remove(5 * self.row_tile_count + 1)

        self.states[5][2] = 0
        self.unused_states.remove(5 * self.row_tile_count + 2)

        self.states[5][3] = 0
        self.unused_states.remove(5 * self.row_tile_count + 3)
    ...
    def seed(self, seed=None):
        ...
        """
        return super(KeyRoomEnvironmentV0, self).seed()
