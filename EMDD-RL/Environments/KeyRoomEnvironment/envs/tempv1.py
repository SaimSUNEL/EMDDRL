from keyroomenvironmentv1 import KeyRoomEnvironmentV1

import pygame

environment = KeyRoomEnvironmentV1(**{'free_travelling_reward': -0.001, 'goal_reward': {38: 5.0}, 'terminal_states': [38], "key state": 4})
...
environment.reset()
environment.render()
environment.saveEnvironmentImage("../../../EnvironmentImages/"+"keyv1forpaper"+".png")
