...
class TwoRoomsEnvironment3X(gym.Env):
    ...
    Note: a default reward range set to [-inf,+inf] already exists. Set it if you want a narrower range.
        ...
        self.tile_width = 20  # px
        self.tile_height = 20  # px

        self.row_tile_count = 51  # number of tiles in a row...
        self.column_tile_count = 10  # number of tiles in a column

        self.screen_width = 1300
        self.screen_height = 306
        ...
        self.states[4][25] = 0
        self.unused_states.remove(4*self.row_tile_count+25)

        self.states[5][25] = 0
        self.unused_states.remove(5 * self.row_tile_count + 25)
    ...
    def render(self, mode='human', close=False):
        ...
        if(self.is_window_created == False):
            ...
            pygame.display.set_caption("Two Rooms 3x")
        ...
        for y in range(self.column_tile_count):
            for x in range(self.row_tile_count):
                ...
                self.screen.blit(text2, ((MARGIN + self.tile_width) * x + MARGIN + 2,
                                         (MARGIN + self.tile_height) * y + MARGIN - 8 + 15))
        ...
        #pygame.draw.circle(self.screen, (255, 0, 0), ((MARGIN + self.tile_width) * agent_coord_x +10+ MARGIN,
        #         (MARGIN + self.tile_height) * agent_coord_y + MARGIN+10), 8, 8)
    ...
    def seed(self, seed=None):
        ...
        """
        return super(TwoRoomsEnvironment3X, self).seed()
