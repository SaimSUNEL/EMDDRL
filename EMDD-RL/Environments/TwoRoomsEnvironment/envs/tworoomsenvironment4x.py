...
class TwoRoomsEnvironment4X(gym.Env):
    ...
    Note: a default reward range set to [-inf,+inf] already exists. Set it if you want a narrower range.
        ...
        self.tile_width = 16  # px
        self.tile_height = 16  # px

        self.row_tile_count = 61  # number of tiles in a row...
    ...
    def render(self, mode='human', close=False):
        ...
        if(self.is_window_created == False):
            ...
            pygame.display.set_caption("Two Rooms 4x")
        ...
        #         (MARGIN + self.tile_height) * agent_coord_y + MARGIN+10), 6, 6)
    ...
    def seed(self, seed=None):
        ...
        """
        return super(TwoRoomsEnvironment4X, self).seed()
