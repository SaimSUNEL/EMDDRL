...
class TwoRoomsEnvironment1X(gym.Env):
    ...
    Note: a default reward range set to [-inf,+inf] already exists. Set it if you want a narrower range.
        ...
        self.row_tile_count = 31  # number of tiles in a row...
        self.column_tile_count = 10  # number of tiles in a column

        self.screen_width = 935
        ...
        self.states[4][15] = 0
        self.unused_states.remove(4*self.row_tile_count+15)

        self.states[5][15] = 0
        self.unused_states.remove(5 * self.row_tile_count + 15)
    ...
    def render(self, mode='human', close=False):
        ...
        if(self.is_window_created == False):
            ...
            pygame.display.set_caption("Two Rooms 1x")
        ...
        #pygame.draw.circle(self.screen, (255, 0, 0), ((MARGIN + self.tile_width) * agent_coord_x +12+ MARGIN,
    ...
    def seed(self, seed=None):
        ...
        """
        return super(TwoRoomsEnvironment1X, self).seed()
