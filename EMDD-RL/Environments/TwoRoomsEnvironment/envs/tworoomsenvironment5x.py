...
class TwoRoomsEnvironment5X(gym.Env):
    ...
    Note: a default reward range set to [-inf,+inf] already exists. Set it if you want a narrower range.
        ...
        self.tile_width = 13  # px
        self.tile_height = 13  # px

        self.row_tile_count = 71  # number of tiles in a row...
        self.column_tile_count = 10  # number of tiles in a column

        self.screen_width = 1290-5
        ...
        self.states[4][35] = 0
        self.unused_states.remove(4*self.row_tile_count+35)

        self.states[5][35] = 0
        self.unused_states.remove(5 * self.row_tile_count + 35)
    ...
    def step(self, action):
        ...
        if next_state in self.terminal_states:
            if reward > 0: # assumes successfull states emits positive reward...
                ...
                finished_succesfully = True
            done = True
        # every action costs little

        # for observation last part will be used...
        return next_state, reward, done, {"issuccesful": finished_succesfully}
    ...
    def render(self, mode='human', close=False):
        ...
        if(self.is_window_created == False):
            ...
            pygame.display.set_caption("Two Rooms 5x")
        ...
        for y in range(self.column_tile_count):
            for x in range(self.row_tile_count):
                ...
                self.screen.blit(text2, ((MARGIN + self.tile_width) * x + MARGIN -1,
                                         (MARGIN + self.tile_height) * y + MARGIN - 8 + 11))
        ...
        #pygame.draw.circle(self.screen, (255, 0, 0), ((MARGIN + self.tile_width) * agent_coord_x +6+ MARGIN,
        #         (MARGIN + self.tile_height) * agent_coord_y + MARGIN+7), 6, 6)
    ...
    def seed(self, seed=None):
        ...
        """
        return super(TwoRoomsEnvironment5X, self).seed()
