...
class TwoRoomsEnvironment2X(gym.Env):
    ...
    Note: a default reward range set to [-inf,+inf] already exists. Set it if you want a narrower range.
        ...
        self.states[4][20] = 0
        self.unused_states.remove(4*self.row_tile_count+20)

        self.states[5][20] = 0
        self.unused_states.remove(5 * self.row_tile_count + 20)
    ...
    def render(self, mode='human', close=False):
        ...
        if(self.is_window_created == False):
            ...
            pygame.display.set_caption("Two Rooms 2x")
    ...
    def seed(self, seed=None):
        ...
        """
        return super(TwoRoomsEnvironment2X, self).seed()
