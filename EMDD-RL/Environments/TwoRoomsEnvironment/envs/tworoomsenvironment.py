...
class TwoRoomsEnvironment(gym.Env):
    ...
    # subgoal count, for displaying how many times it was chosen as subgoal
    ...
    def getEnvironmentGraph(self):
        ...
        for state in range(self.row_tile_count * self.column_tile_count):
            ...
            for action in range(4):
                next_state = self.get_next_state_and_reward(state, action)
                if next_state != state:
    ...
    def seed(self, seed=None):
        ...
        """
        return super(TwoRoomsEnvironment, self).seed()