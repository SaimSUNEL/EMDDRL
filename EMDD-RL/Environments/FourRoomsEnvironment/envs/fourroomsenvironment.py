...
class FourRoomsEnvironment(gym.Env):
    ...
    Note: a default reward range set to [-inf,+inf] already exists. Set it if you want a narrower range.
        ...
        self.tile_width = 28  # px
        self.tile_height = 28  # px

        self.row_tile_count = 21  # number of tiles in a row...
        self.column_tile_count = 21  # number of tiles in a column

        self.screen_width = 698
        ...
        for x_ in range(10):
            for y_ in [10]:
                self.starting_state.remove(x_ + y_ * self.row_tile_count)
        ...
        self.states[10][4] = 0
        self.unused_states.remove(10 * self.row_tile_count + 4)

        self.states[10][16] = 0
        self.unused_states.remove(10 * self.row_tile_count + 16)


        self.states[15][10] = 0
        self.unused_states.remove(15 * self.row_tile_count + 10)
    ...
    def render(self, mode='human', close=False):
        ...
        if(self.is_window_created == False):
            ...
            pygame.display.set_caption("Four Rooms")
            self.screen.fill((0, 0, 0))
            self.is_window_created = True
            self.font = pygame.font.SysFont("comicsansms", 30)
            self.font2 = pygame.font.SysFont("comicsansms", 10)
        ...
        for y in range(self.column_tile_count):
            for x in range(self.row_tile_count):
                ...
                self.screen.blit(text2, ((MARGIN + self.tile_width) * x + MARGIN + 1,
                                         (MARGIN + self.tile_height) * y + MARGIN - 8 + 8))
        ...
        #pygame.draw.circle(self.screen, (255, 0, 0), ((MARGIN + self.tile_width) * agent_coord_x +15+ MARGIN,
        #         (MARGIN + self.tile_height) * agent_coord_y + MARGIN+12), 10, 10)
    ...
    def seed(self, seed=None):
        ...
        """
        return super(FourRoomsEnvironment, self).seed()
