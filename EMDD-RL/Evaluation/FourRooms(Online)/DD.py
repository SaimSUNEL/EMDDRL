...
experiment_folder_path = "../../FourRoomExperiments/AccuracyExperimentsFourRooms(Online)/ActionNoise(0.9)StepLimit(400)/STEPLIMITEQUALLYBALANCED"

DD_RESULT = None


subgoal_regions = {1: [214], 2:[94], 3:[325]}
