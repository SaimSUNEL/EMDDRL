...
experiment_folder_path = "../../TwoRoomExperiments1X/AccuracyExperimentsTwoRoom1X(Online)/ActionNoise(0.9)StepLimit(300)/STEPLIMITEQUALLYBALANCED"

EMDD_RESULTS = dict()


subgoal_regions = {1: [139, 170]}
